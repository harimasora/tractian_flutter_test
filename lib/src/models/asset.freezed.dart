...
class _$AssetImpl implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, name: $name, parentId: $parentId, sensorId: $sensorId, sensorType: $sensorType, status: $status, gatewayId: $gatewayId, locationId: $locationId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, parentId, sensorId,
      sensorType, status, gatewayId, locationId);
...
abstract class _Asset implements Asset {
  const factory _Asset(
      ...
      final String? status,
      final String? gatewayId,
      final String? locationId}) = _$AssetImpl;
